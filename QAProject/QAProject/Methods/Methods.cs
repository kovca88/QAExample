...
namespace QAProject.Methods
{
    public class Methods
    {
        ...
        public static void MoveToElement(IWebDriver webDriver, string elementName, int timeInSeconds)
        {
            var element = webDriver.FindElement(By.CssSelector(elementName));
